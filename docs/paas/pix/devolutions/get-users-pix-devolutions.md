...
axios({
  method: 'get',
  url: 'https://api-dev159sw.zrobank.biz:2083/v3/pix/devolutions?page=1&size=20&order=asc&states=CONFIRMED',
  headers: {
...
```shell title=CURL
curl -X 'GET' \
  'https://api-dev159sw.zrobank.biz:2083/v3/pix/devolutions?page=1&size=20&order=asc&states=CONFIRMED' \
