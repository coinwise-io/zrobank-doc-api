...
axios({
  method: 'get',
  url: 'https://api-dev159sw.zrobank.biz:2083/v3/pix/devolutions/e5c8e59d-6f37-4c55-8b9a-1366f378abfd',
  headers: {
...
```shell title=CURL
curl -X 'GET' \
  'https://api-dev159sw.zrobank.biz:2083/v3/pix/devolutions/e5c8e59d-6f37-4c55-8b9a-1366f378abfd' \
