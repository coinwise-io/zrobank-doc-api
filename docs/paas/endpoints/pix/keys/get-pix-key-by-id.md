...
axios({
  method: 'get',
  url: 'https://api-dev159sw.zrobank.biz:2083/pix/keys/9973c013-2eba-4b11-9828-1d458f30861e',
  headers: {
...
```shell title=CURL
curl -X 'GET' \
  'https://api-dev159sw.zrobank.biz:2083/pix/keys/9973c013-2eba-4b11-9828-1d458f30861e' \
