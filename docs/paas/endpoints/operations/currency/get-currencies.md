...
axios({
  method: 'get',
  url: 'https://api-dev159sw.zrobank.biz:2083/operations/currencies?page=1&size=20&order=asc&symbol=BRL',
  headers: {
...
```shell title=CURL
curl -X 'GET' \
  'https://api-dev159sw.zrobank.biz:2083/operations/currencies?page=1&size=20&order=asc&symbol=BRL' \
